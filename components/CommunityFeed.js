...
export default function CommunityFeed() {
    ...
    const handleTwitterShare = (post, e) => {
        e.preventDefault();
        const url = `${window.location.origin}/community/${post.id}`;
        const text = post.title
            ? `Read "${post.title}" on Run & Write ✍️`
            : `Check out this story on Run & Write ✍️`;
        window.open(
                        ...
                        >
                            ...
                            <div className="mt-4 flex items-center justify-between relative z-10 pointer-events-none">
                                ...
                                <div className="flex items-center gap-4 pointer-events-auto">
                                     ...
                                     <button
                                        onClick={(e) => handleTwitterShare(item, e)}
                                        className="text-gray-500 hover:text-sky-500 dark:text-gray-400 dark:hover:text-sky-400 transition"
