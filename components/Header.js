    ...
    return (
        <header className="text-center mb-8">
            ...
            <div className="mt-4 flex justify-center gap-4 flex-wrap">
                 ...
                 <Link href="/community" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 bg-gray-200 rounded-lg shadow hover:bg-gray-300 focus:outline-none dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
                    Community Feed
                </Link>
                {session?.user?.id && (
                    <Link href={`/profile/${session.user.id}`} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 bg-gray-200 rounded-lg shadow hover:bg-gray-300 focus:outline-none dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
                        My Profile
                    </Link>
                )}
            </div>
